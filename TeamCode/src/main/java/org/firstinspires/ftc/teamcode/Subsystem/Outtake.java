...
public class Outtake {
    ...
    public InstantAction BucketCommands(Outtake.BucketState state) {
        return new InstantAction(() -> updateBucketState(state));
    }

    public InstantAction LifterCommands(Outtake.LifterState state) {
        return new InstantAction(() -> updateLifterState(state));
    }

    public InstantAction SpecimenCommands(Outtake.SpecimenState state) {
