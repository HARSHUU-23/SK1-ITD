...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5707.207837752002; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -6453.9746320940585; // x position of the perpendicular encoder (in tick units)
    }
