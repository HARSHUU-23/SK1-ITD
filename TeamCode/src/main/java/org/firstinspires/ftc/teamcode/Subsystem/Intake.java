...
public class Intake {
    ...
    public enum YawState {
        INIT, HALF, DROP, LEFT, RIGHT, FULL_LEFT, FULL_RIGHT, MID_LEFT, MID_RIGHT
    }
    ...
    public InstantAction ArmCommands(Intake.ArmState state) {
        return new InstantAction(() -> updateArmState(state));
    }

    public InstantAction ElbowCommands(Intake.ElbowState state) {
        return new InstantAction(() -> updateElbowState(state));
    }

    public Action YawCommands(Intake.YawState state) {
        return new InstantAction(() -> updateYawState(state));
    }

    public InstantAction IntakeMotorCommands(Intake.IntakeMotorState state) {
